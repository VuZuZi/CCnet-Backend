...
import { PROJECT_STATUS, PROJECT_CATEGORY, MILESTONE_STATUS } from './project.constant.js';
...
const milestoneSchema = new mongoose.Schema({
    ...
    disbursementRequestId: { type: mongoose.Schema.Types.ObjectId, ref: 'DisbursementRequest', default: null }
}, { _id: false });
...
const projectSchema = new mongoose.Schema({
    ...
    category: { type: String, enum: Object.values(PROJECT_CATEGORY), required: true, index: true },
    ...
    status: { type: String, enum: Object.values(PROJECT_STATUS), default: PROJECT_STATUS.DRAFT, index: true },
    ...
    fromHelpRequestId: { type: mongoose.Schema.Types.ObjectId, ref: 'HelpRequest', default: null },
...
projectSchema.index(
    ...
    { weights: { title: 10, 'location.address': 5, description: 1 }, name: 'ProjectTextIndex' }
);
