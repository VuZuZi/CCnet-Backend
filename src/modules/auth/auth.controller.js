...
class AuthController {
  ...
  register = async (req, res, next) => {
    try {
      ...
      return ApiResponse.created(res, result, 'Registration successful. Please verify OTP.');
  ...
  refreshToken = async (req, res, next) => {
    try {
      ...
      return ApiResponse.success(res, { accessToken: result.accessToken }, 'Access token refreshed');
    } catch (error) { next(error); }
  };
  ...
  resendOTP = async (req, res, next) => {
    try {
      ...
      return ApiResponse.success(res, null, 'OTP has been resent to your email');
    } catch (error) { next(error); }
  };
